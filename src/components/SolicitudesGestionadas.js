                  ...
                  <div className="col">
                      <div className="table-responsive">
                          <table className="table table-hover">
                              ...
                              <tbody>
                              {solicitudes_gestionadas.data.getSolicitudesByBibliotecario.map((solicitudes, index) =>
                              <tr key={index}>
                                  <th scope="row">
                                  ...
                                  <td className="align-middle">
                                    {solicitudes.estado_solicitud === true ? <h5><span Name="badge bg-success">Gestionada</span></h5>:
