...
export class Comprobante extends Component {
    constructor(props){
        super(props);
          ...
          <div className="text-left">
            ...
            <div className="row d-flex align-items-baseline">
              ...
              <div className="col-xl-9">
                <p style={{color: "#7e8d9f", fontSize: "20px"}}>Comprobante  <strong>ID: {comprobante.data.getComprobante.id}</strong></p>
              </div>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-xl-8">
                  <ul className="list-unstyled">
                    ...
                    <li className="text-muted"><span >{comprobante.data.getComprobante.usuario.nombre} {comprobante.data.getComprobante.usuario.apellido}</span></li>
                    <li className="text-muted">{comprobante.data.getComprobante.usuario.rut}</li>
                    <li className="text-muted">{comprobante.data.getComprobante.usuario.direccion}</li>
                    <li className="text-muted"><i className="bi bi-telephone-fill me-1"></i>{comprobante.data.getComprobante.usuario.telefono}</li>
                    <li className="text-muted"><i className="bi bi-envelope-fill me-1"></i>{comprobante.data.getComprobante.usuario.correo}</li>
                  </ul>

                  <ul className="list-unstyled">
                    <li className="text-muted"> <span className="fw-bold">Datos de bibliotecario</span></li>
                    <li className="text-muted"><span>{comprobante.data.getComprobante.bibliotecario.nombre} {comprobante.data.getComprobante.bibliotecario.apellido}</span></li>
                    <li className="text-muted">{comprobante.data.getComprobante.bibliotecario.rut}</li>
                  </ul>
                </div>
                <div className="col-xl-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="text-muted"><i className="fas fa-circle" style={{color:"#84B0CA"}}></i> <span
                        className="fw-bold">ID:</span> {comprobante.data.getComprobante.id}</li>
                    <li className="text-muted"><i className="fas fa-circle" style={{color:"#84B0CA"}}></i> <span
                        className="fw-bold">Fecha de préstamo: </span>{comprobante.data.getComprobante.fecha_prestamo}</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="row my-2 mx-1 justify-content-center">
                <table className="table table-striped table-borderless">
                  ...
                  <tbody className="">
                    {comprobante.data.getComprobante.prestamos.map((prestamo, index) => 
